...
static inline void rdi_create(WlsMesh *mesh, ::coder::SizeType degree,
                              RdiObject *rdi);
...
static inline void rdi_create5(WlsMesh *mesh, ::coder::SizeType degree,
                               ::coder::SizeType nparts,
                               ::coder::SizeType nrmid, real_T ring,
                               RdiObject *rdi);

static inline void rdi_create(WlsMesh *mesh, ::coder::SizeType degree,
                              ::coder::SizeType nparts, ::coder::SizeType nrmid,
                              real_T ring, ::coder::SizeType varargin_2,
                              RdiObject *rdi);

static inline void rdi_create7(WlsMesh *mesh, ::coder::SizeType degree,
                               ::coder::SizeType nparts,
                               ::coder::SizeType nrmid, real_T ring,
                               RdiObject *rdi);
